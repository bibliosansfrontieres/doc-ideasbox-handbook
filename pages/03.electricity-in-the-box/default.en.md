...
Working volatage / frequency : 90-265 VCA 50/60 Hz

Datasheet : https://www.victronenergy.fr/upload/documents/Datasheet-Centaur-Charger-FR.pdf
...
The standard two-prong and ground pin plug allows the Ideas Box to connect to a 220-V outlet or a generator.  The other end can plug directly into the male IEC plug of the electrical modules (i.e. the Cinema or Administration modules)
